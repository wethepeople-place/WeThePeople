...
export default function ActHubPage() {
  ...
  return <main className="min-h-screen bg-[#080f1c] px-3 pb-32 pt-4 text-white sm:px-8 sm:py-12">
    <div className="mx-auto max-w-6xl">
      ...
      <Link to="/forecasts" className="mt-4 inline-flex min-h-11 items-center gap-2 rounded-full border border-amber-300/40 px-4 font-bold text-amber-200 outline-none hover:bg-amber-300/10 focus-visible:ring-4 focus-visible:ring-amber-300/40"><Vote className="h-4 w-4" />Explore civic forecasts<ChevronRight className="h-4 w-4" /></Link>
