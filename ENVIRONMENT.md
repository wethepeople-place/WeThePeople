...
| Group | Variables |
|---|---|
| Official civic data | `CONGRESS_API_KEY` (legacy alias: `API_KEY_CONGRESS`), `HUD_API_KEY`, optional `BLS_API_KEY`, `FEC_API_KEY`, `API_KEY_GOOGLE_CIVIC`, `GOVINFO_API_KEY`, `DATAGOV_API_KEY`, `OPENSTATES_API_KEY`, `REGULATIONS_GOV_API_KEY`, `SAM_GOV_API_KEY` |
